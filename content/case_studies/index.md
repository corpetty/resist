...
<div id="timeline" style="width:100%; min-height:200px; margin:20px 0;"></div>

---

## Movement DNA Comparison

Select up to 3 movements to compare across 6 dimensions:

<div id="radar-container" style="margin: 20px 0;">
<div style="margin-bottom: 12px;">
<select id="movement-select" multiple style="width:100%; max-width:400px; height:120px; font-size:14px; padding:4px; background:var(--light); color:var(--darkgray); border:1px solid var(--gray); border-radius:4px;"></select>
<br/>
<button id="compare-btn" style="margin-top:8px; padding:6px 16px; background:var(--secondary); color:var(--light); border:none; border-radius:4px; cursor:pointer; font-size:14px;">Compare</button>
</div>
